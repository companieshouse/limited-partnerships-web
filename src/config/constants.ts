...
export const DATE_EFFECTIVE_FROM_FIELD = "date_effective_from";
export const CEASE_DATE_FIELD = "cease_date";
...
export const NOT_DISQUALIFIED_STATEMENT_CHECKED_FIELD = "not_disqualified_statement_checked";
