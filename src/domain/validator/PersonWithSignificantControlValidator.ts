...
import RelevantLegalEntityPscValidator from "./RelevantLegalEntityPscValidator";
...
export default class PersonWithSignificantControlValidator {
  ...
  set(data: PscFormData, i18n: any): this {
    ...
    } else if (data.type === PersonWithSignificantControlType.RELEVANT_LEGAL_ENTITY) {
      this.delegate = new RelevantLegalEntityPscValidator().set(data, i18n);
    } else {
      this.delegate = null;
    }
    return this;
