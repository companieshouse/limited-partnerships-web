...
export const containsInvalidCharacters = (fieldValue: string | undefined, fieldName: string, uiErrors: UIErrors, errorMessage: string): boolean => {
...
export const isFieldValueMissing = (fieldValue: string | undefined, fieldName: string, uiErrors: UIErrors, errorMessage: string): boolean => {
...
export const isFieldValueTooLong = (fieldValue: string | undefined, maxLength: number, fieldName: string, uiErrors: UIErrors, errorMessage: string): boolean => {
...
export const validateField = (fieldValue: string | undefined, fieldName: string, maxLength: number, uiErrors: UIErrors, errorMessages: Record<string, string>) => {
