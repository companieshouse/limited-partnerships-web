...
describe("Choose principal office address of the limited partner page", () => {
  ...
  describe("GET choose principal office address of the limited partner page", () => {
    it.each(
    ...
    )("should load the limited partner choose principal office address page with %s text", async (lang: string) => {
      ...
      testTranslations(res.text, translationText.address.chooseAddress.limitedPartnerPrincipalOfficeAddress);
      if (lang === "en") {
