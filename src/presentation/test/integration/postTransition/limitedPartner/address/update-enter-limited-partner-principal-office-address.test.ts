...
describe("Enter limited partner's principal office manual address page - legal entity", () => {
  ...
  describe("Get enter limited partner's principal office address page", () => {
    it("should load enter limited partners principal office address page with English text", async () => {
      ...
      const BACK_LINK = getUrl(UPDATE_LIMITED_PARTNER_PRINCIPAL_OFFICE_ADDRESS_YES_NO_URL);
