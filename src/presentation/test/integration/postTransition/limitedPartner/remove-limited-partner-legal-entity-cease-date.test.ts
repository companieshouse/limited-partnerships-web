...
describe("Limited Partner cease date page", () => {
  ...
  describe("GET limited partner cease date page", () => {
    it("should load limited partner cease date page with english text", async () => {
    ...
    it("should load limited partner cease date page with welsh text", async () => {
  ...
  describe("Post limited partner cease date page", () => {
