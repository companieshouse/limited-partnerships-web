...
describe("Choose usual residential address of the general partner page", () => {
  ...
  describe("GET choose usual residential address of the general partner page", () => {
    it.each([
      ...
      "should load the choose usual residential address of the general partner page with Welsh text",
    ...
    it.each([
      ...
      "should load the choose usual residential address of the general partner page with English text",
      async (partnerKind, serviceName) => {
        setLocalesEnabled(true);
