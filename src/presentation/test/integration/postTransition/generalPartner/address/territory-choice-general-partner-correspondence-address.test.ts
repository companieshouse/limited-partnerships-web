...
describe("General Partner Correspondence Address Territory Choice", () => {
  ...
  describe("Get general partner correspondance address territory choice page", () => {
    it.each([
      ...
      "should load the general partner correspondance address territory choice page with Welsh text",
    ...
    it.each([
      ...
      "should load the general partner correspondance address territory choice page with English text",
      async (partnerKind, serviceName) => {
        setLocalesEnabled(true);
