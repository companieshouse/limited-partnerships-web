...
import { UPDATE_GENERAL_PARTNER_LEGAL_ENTITY_CHECK_YOUR_ANSWERS_URL, WHEN_DID_GENERAL_PARTNER_LEGAL_ENTITY_DETAILS_CHANGE_URL } from "../../../../../controller/postTransition/url";
...
describe("Update general partner check your answers page", () => {
  ...
  describe("GET update general partner check your answers page", () => {
    it("should load update general partner check your answers page with english text", async () => {
      ...
      expectChangeLinks(res.text, [WHEN_DID_GENERAL_PARTNER_LEGAL_ENTITY_DETAILS_CHANGE_URL]);
