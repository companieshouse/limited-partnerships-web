...
import { REMOVE_GENERAL_PARTNER_LEGAL_ENTITY_CHECK_YOUR_ANSWERS_URL } from "../../../../../controller/postTransition/url";
import GeneralPartnerBuilder from "../../../../builder/GeneralPartnerBuilder";
import TransactionBuilder from "../../../../builder/TransactionBuilder";

describe("Remove general partner check your answers page", () => {
  const URL = getUrl(REMOVE_GENERAL_PARTNER_LEGAL_ENTITY_CHECK_YOUR_ANSWERS_URL);
  ...
  beforeEach(() => {
    ...
    const transaction = new TransactionBuilder().withKind(PartnerKind.REMOVE_GENERAL_PARTNER_LEGAL_ENTITY).build();
  ...
  describe("GET remove general partner check your answers page", () => {
    it("should load remove general partner check your answers page with english text", async () => {
      ...
      expect(res.text).toContain(enTranslationText.serviceName.removeGeneralPartnerEntity);
    });
    ...
    it("should load remove general partner check your answers page with welsh text", async () => {
      ...
      expect(res.text).toContain(cyTranslationText.serviceName.removeGeneralPartnerEntity);
    });
  });
});
