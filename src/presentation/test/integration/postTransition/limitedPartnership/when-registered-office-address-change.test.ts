...
import { WHEN_REGISTERED_OFFICE_ADDRESS_CHANGE_URL } from "../../../../controller/postTransition/url";
import CompanyProfileBuilder from "../../../builder/CompanyProfileBuilder";
import PostTransitionPageType from "../../../../controller/postTransition/pageType";
import LimitedPartnershipBuilder from "../../../../test/builder/LimitedPartnershipBuilder";

describe("Registered office address change date page", () => {
  const URL = getUrl(WHEN_REGISTERED_OFFICE_ADDRESS_CHANGE_URL);
