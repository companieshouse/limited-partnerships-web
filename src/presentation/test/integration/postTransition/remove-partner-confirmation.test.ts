...
describe("Remove partner confirmation page", () => {
  ...
  describe("Get remove partner confirmation page", () => {
    it.each([
      ...
      "should load remove partner confirmation page with english text",
      async (partnerKind, isLimitedPartner, isPerson, serviceName) => {
    ...
    it.each([
      ...
      "should load remove partner confirmation page with welsh text",
      async (partnerKind, isLimitedPartner, isPerson, serviceName) => {
        const transaction = new TransactionBuilder().withKind(partnerKind).build();
        appDevDependencies.transactionGateway.feedTransactions([transaction]);
