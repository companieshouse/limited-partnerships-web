  ...
  describe("Get Remove Limited Partners Page", () => {
    it("should load the remove limited partners page with English text", async () => {
      ...
      expect(res.text).toContain(
        `${enTranslationText.partner.removePartnerPage.title} - ${enTranslationText.serviceTransition} - GOV.UK`
      );
    ...
    it("should load the remove limited partners page with Welsh text", async () => {
      ...
      expect(res.text).toContain(
        `${cyTranslationText.partner.removePartnerPage.title} - ${cyTranslationText.serviceTransition} - GOV.UK`
      );
