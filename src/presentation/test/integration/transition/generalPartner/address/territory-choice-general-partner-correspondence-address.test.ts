  ...
  describe("Get general partner correspondance address territory choice page", () => {
    it("should load the general partner correspondance address territory choice page with Welsh text", async () => {
      ...
      expect(res.text).toContain(
        toEscapedHtml(
          `${cyTranslationText.address.territoryChoice.generalPartnerCorrespondenceAddress.title} - ${cyTranslationText.serviceTransition} - GOV.UK`
        )
      );
    ...
    it("should load the general partner correspondance address territory choice page with English text", async () => {
      ...
      expect(res.text).toContain(
        toEscapedHtml(
          `${enTranslationText.address.territoryChoice.generalPartnerCorrespondenceAddress.title} - ${enTranslationText.serviceTransition} - GOV.UK`
        )
      );
