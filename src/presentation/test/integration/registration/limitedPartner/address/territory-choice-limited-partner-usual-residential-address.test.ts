  ...
  describe("GET limited-partner-usual-residential-address-choose-territory", () => {
    it("should load the limited partner usual residential address territory choice page with Welsh text", async () => {
      ...
      expect(res.text).toContain(
        toEscapedHtml(
          `${cyTranslationText.address.territoryChoice.limitedPartnerUsualResidentialAddress.title} - ${cyTranslationText.serviceRegistration} - GOV.UK`
        )
      );
    ...
    it("should load the limited partner usual residential address territory choice page with English text", async () => {
      ...
      expect(res.text).toContain(
        toEscapedHtml(
          `${enTranslationText.address.territoryChoice.limitedPartnerUsualResidentialAddress.title} - ${enTranslationText.serviceRegistration} - GOV.UK`
        )
      );
