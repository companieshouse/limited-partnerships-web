...
import { ADD_GENERAL_PARTNER_LEGAL_ENTITY_URL, ADD_GENERAL_PARTNER_PERSON_WITH_ID_URL } from "../../../../controller/registration/url";
...
describe("Add General Partner Legal Entity Page", () => {
  ...
  describe("200", () => {
    it("should add general partner legal entity", async () => {
