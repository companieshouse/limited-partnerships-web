  ...
  describe("Get Postcode Registered Office Address Page", () => {
    it("should load the office address page with English text", async () => {
      ...
      expect(res.text).toContain(
        `${enTranslationText.address.findPostcode.registeredOfficeAddress.whatIsOfficeAddress} - ${enTranslationText.serviceRegistration} - GOV.UK`
      );
    ...
    it("should load the office address page with Welsh text", async () => {
      ...
      expect(res.status).toBe(200);
      expect(res.text).toContain(
        `${cyTranslationText.address.findPostcode.registeredOfficeAddress.whatIsOfficeAddress} - ${cyTranslationText.serviceRegistration} - GOV.UK`
      );
