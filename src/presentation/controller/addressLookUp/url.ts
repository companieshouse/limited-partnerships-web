...
export const CHOOSE_GENERAL_PARTNER_USUAL_RESIDENTIAL_ADDRESS_URL = `${BASE_WITH_IDS_URL}/${template.CHOOSE_GENERAL_PARTNER_USUAL_RESIDENTIAL_ADDRESS_TEMPLATE}`;
export const CONFIRM_GENERAL_PARTNER_USUAL_RESIDENTIAL_ADDRESS_URL = `${BASE_WITH_IDS_URL}`;
