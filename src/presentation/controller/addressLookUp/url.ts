...
export const ENTER_USUAL_RESIDENTIAL_ADDRESS_URL = `${GENERAL_PARTNER_WITH_ID_URL}/${template.ENTER_USUAL_RESIDENTIAL_ADDRESS_TEMPLATE}`;
export const GENERAL_PARTNER_USUAL_RESIDENTIAL_ADDRESS_CHOOSE_TERRITORY_URL = `${GENERAL_PARTNER_WITH_ID_URL}/${template.GENERAL_PARTNER_USUAL_RESIDENTIAL_ADDRESS_CHOOSE_TERRITORY_TEMPLATE}`;
...
export const CONFIRM_GENERAL_PARTNER_USUAL_RESIDENTIAL_ADDRESS_URL = `${BASE_WITH_IDS_URL}`; // TODO Include the 'confirm URA page' URL when page is ready
