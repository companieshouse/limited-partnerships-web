...
export const GENERAL_PARTNER_USUAL_RESIDENTIAL_ADDRESS_CHOICE_URL = `${BASE_WITH_IDS_URL}/${template.GENERAL_PARTNER_USUAL_RESIDENTIAL_ADDRESS_CHOICE_TEMPLATE}`;
