...
export const GENERAL_PARTNER_USUAL_RESIDENTIAL_ADDRESS_CHOICE_URL = `${GENERAL_PARTNER_WITH_ID_URL}/${template.GENERAL_PARTNER_USUAL_RESIDENTIAL_ADDRESS_CHOICE_TEMPLATE}`;
