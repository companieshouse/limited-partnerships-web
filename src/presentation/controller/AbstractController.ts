...
import {
  ADD_GENERAL_PARTNER_LEGAL_ENTITY_URL as ADD_GENERAL_PARTNER_LEGAL_ENTITY_URL_TRANSACTION,
  ADD_GENERAL_PARTNER_PERSON_URL as ADD_GENERAL_PARTNER_PERSON_URL_TRANSACTION
} from "./transition/url";
...
abstract class AbstractController {
  ...
  private replaceBaseUrlWithIds(url: string, ids: Ids) {
    ...
    const GP_URLS = [
      ADD_GENERAL_PARTNER_PERSON_URL,
      ADD_GENERAL_PARTNER_PERSON_URL_TRANSACTION,
      ADD_GENERAL_PARTNER_LEGAL_ENTITY_URL,
      ADD_GENERAL_PARTNER_LEGAL_ENTITY_URL_TRANSACTION
    ];
