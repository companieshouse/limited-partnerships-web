...
const postTransitionRoutingAddLimitedPartnerPerson = {
  ...
  currentUrlWithLimitedPartnerId: url.ADD_LIMITED_PARTNER_PERSON_WITH_IDS_URL,
...
const postTransitionRoutingAddLimitedPartnerLegalEntity = {
  ...
  currentUrlWithLimitedPartnerId: url.ADD_LIMITED_PARTNER_LEGAL_ENTITY_WITH_IDS_URL,
