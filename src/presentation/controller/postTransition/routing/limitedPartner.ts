...
const postTransitionRoutingUpdateLimitedPartnerPersonCheckYourAnswers = {
  ...
  data: {
    ...
    uraChangeLink: PostTransitionPageType.updateLimitedPartnerUsualResidentialAddressYesNo
  }
};
...
const postTransitionRoutingUpdateLimitedPartnerLegalEntityCheckYourAnswers = {
  ...
  data: {
    ...
    legalEntityChangeLink: PostTransitionPageType.updateLimitedPartnerLegalEntity,
    principalOfficeAddressChangeLink: PostTransitionPageType.updateLimitedPartnerPrincipalOfficeAddressYesNo
  }
};

const postTransitionRoutingLimitedPartnerStopScreenNoChange = {
  previousUrl: url.UPDATE_LIMITED_PARTNER_PERSON_WITH_IDS_URL,
  currentUrl: url.UPDATE_LIMITED_PARTNER_STOP_SCREEN_NO_CHANGE_URL,
  nextUrl: "/",
...
const limitedPartnerRouting = [
  ...
  postTransitionRoutingLimitedPartnerStopScreenNoChange
];
